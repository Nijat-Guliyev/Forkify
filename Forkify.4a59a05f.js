...
const controlAddBookmark = function() {
    ...
    (0, _recipeViewJsDefault.default).toggleBookmarkStyle(_modelJs.state.recipe.bookmarked);
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
    // 3) Render bookmarks
...
const loadRecipe = async function(id) {
    try {
        ...
        console.error(`${error} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`);
        throw error;
    }
};
...
const KEY = 'b3f7b202-7f27-42fb-8908-9ee007bda3fc';
...
const timeout = function(s) {
    return new Promise(function(_, reject) {
        setTimeout(()=>{
            reject(new Error(`Request too long! Timeout after ${s} second`));
        }, s * 1000);
    });
};
const AJAX = async function(url, uploadData) {
 ...
 //   }
 // };
 // 2) Long way or a bit of straightforward
 // export const sendJSON = async function (url, uploadData) {
 //   try {
...
// import icons from '../img/sprite.svg'; // Parcel 1
var _spriteSvg = require("url:../../img/sprite.svg"); // Parcel 2
var _spriteSvgDefault = parcelHelpers.interopDefault(_spriteSvg);
// import { Fraction } from 'fractional'; -- It happened error in fraction site
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener('click', function(event) {
            const btn = event.target.closest('.btn__update-serving');
            if (!btn) return;
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${0, _spriteSvgDefault.default}#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${0, _spriteSvgDefault.default}#icon-users"></use>
            </svg>
            ...
            <div class="recipe__info-buttons">
              <button data-update-to="${this._data.servings - 1}" class="btn__tiny btn__update-serving">
                <svg>
                  <use href="${0, _spriteSvgDefault.default}#icon-circle-with-minus"></use>
                </svg>
              </button>
              <button data-update-to="${this._data.servings + 1}" class="btn__tiny btn__update-serving">
                <svg>
                  <use href="${0, _spriteSvgDefault.default}#icon-circle-with-plus"></use>
                </svg>
              </button>
            </div>
          </div> 
          ...
          <div class="recipe__user-generated ${this._data.key ? '' : 'hidden'}">
            ...
            <button class="btn__round btn--bookmark ${this._data.bookmarked ? 'bookmarked' : ''}">
              <svg>
                 <use href="${0, _spriteSvgDefault.default}#icon-bookmark"></use>
              </svg>
           </button>
        </div>
        ...
        <div class="recipe__directions">
          ...
          >
            ...
            <svg class="search__icon">
              <use href="${0, _spriteSvgDefault.default}#icon-arrow-long-right"></use>
            </svg>
          </a>
        </div> 
        `;
    ...
    _generateMarkupIngredient(ing) {
      ...
      <li class="recipe__ingredient">
        <svg class="recipe__icon">
          <use href="${0, _spriteSvgDefault.default}#icon-check"></use>
        </svg>
    ...
    toggleBookmarkStyle(isBookmarked) {
...
},{"./View.js":"jSw21","url:../../img/sprite.svg":"hSAN1","fracty":"gsPKI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jSw21":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _spriteSvg = require("url:../../img/sprite.svg"); // Parcel 2
var _spriteSvgDefault = parcelHelpers.interopDefault(_spriteSvg);
class View {
   ...
   */ render(data, render = true) {
    ...
    renderMessage(message = this._message) {
       ...
       <div class="message">
          <svg class="search__icon">
            <use href="${(0, _spriteSvgDefault.default)}#icon-emoji-happy"></use>
          </svg>
          <p>${message}</p>
       </div>
       `;
...
},{"url:../../img/sprite.svg":"hSAN1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hSAN1":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("sprite.07b3632a.svg") + "?" + Date.now();
...
},{"./View.js":"jSw21","./previewView.js":"6tKHS","url:../../img/sprite.svg":"hSAN1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class PreviewView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        return `
        <li class="preview">
            <a href="#${this._data.id}" class="preview__link ${this._data.id === id ? 'preview__link-active' : ''}">
...
},{"./View.js":"jSw21","url:../../img/sprite.svg":"hSAN1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7NIiB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkupButtonPrevious(currentPage) {
      ...
      <button data-goto="${currentPage - 1}" class="btn--inline pagination__btn--prev">
          <svg class="search__icon">
          <use href="${0, _spriteSvgDefault.default}#icon-arrow-long-left"></use>
          </svg>
...
},{"./View.js":"jSw21","url:../../img/sprite.svg":"hSAN1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1qGeA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"jSw21","./previewView.js":"6tKHS","url:../../img/sprite.svg":"hSAN1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"jSw21","url:../../img/sprite.svg":"hSAN1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
},{}]},["9NBY4","7dWZ8"], "7dWZ8", "parcelRequire3a11", "./", "/")
